    ...
    .defines(function () {
        Camera = ig.Class.extend({
            ...
            onWindowResize: function () {
                // When the window resizes, we need to reset all of these properties based on the new window size.
                this.resizeCameraProperties();
            },

            resizeCameraProperties: function () {
                this.offset.x = ig.system.width / 2;
                this.offset.y = ig.system.height / 3;
                this.trap.size.x = ig.system.width / 15;
                this.trap.size.y = ig.system.height / 3;
                this.lookAhead.x = ig.ua.mobile ? ig.system.width / 6 : 0;
                // Set camera max and reposition trap
                this.max.x = ig.game.collisionMap.width * ig.game.collisionMap.tilesize - ig.system.width;
                this.max.y = ig.game.collisionMap.height * ig.game.collisionMap.tilesize - ig.system.height;
            }
        });
    });
